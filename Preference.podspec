#
#  Be sure to run `pod spec lint Preference.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "shivanivs"
  # s.authors            = { "shivanivs" => "shivani.arora@vectoscalar.com" }
  # s.social_media_url   = "http://twitter.com/shivanivs"
  ...
  s.source       = { :git => "https://github.com/shivanivs/Preferences.git" }
  ...
  s.source_files  = "Preferences/Source/*.{h,m}"
